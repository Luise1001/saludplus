                ...
                <div class="card-body p-lg-17">
                    ...
                    <div class="position-relative mb-17">
                        ...
                        <div class="position-absolute text-white mb-8 ms-10 bottom-0">
                            ...
                            <div class="fs-5 fw-semibold">Este formulario solo se solicitará una vez para obtener los datos
                            ...
                            <form action="{{ route('patient.register') }}" class="form mb-15" method="post"
                                ...
                                <div class="row mb-5">
                                    <div class="col-md-6 fv-row">
                                        <label class="required fs-5 fw-semibold mb-2">Cédula</label>
                                        <input type="text" class="form-control form-control-solid"
                                            placeholder="V123456789" name="document" value="{{ $document ?? '' }}" />
                                    </div>

                                    <div class="col-md-6 fv-row">
                                        <label class="required fs-5 fw-semibold mb-2">Fecha de nacimiento</label>
                                        <input type="text" class="form-control form-control-solid"
                                            placeholder="Fecha de nacimiento" id="date_birth" name="date_birth" />
                                    </div>
                                </div>
                                ...
                                <div class="row mb-5">
                                    ...
                                    <div class="col-md-6 fv-row">
                                        <label class="required fs-5 fw-semibold mb-2">Apellidos</label>
                                        <input type="text" class="form-control form-control-solid"
                                ...
                                <div class="row mb-5">
                                    <div class="col-md-6 fv-row">
                                        <label class="fs-5 fw-semibold mb-2">Correo eléctronico</label>
                                ...
                                <div class="row mb-5">
                                    <div class="col-md-6 fv-row">
                                        <label class="required fs-5 fw-semibold mb-2">Edad</label>
                                        <input type="text" class="form-control form-control-solid" placeholder="Edad"
                                            name="age" />
                                    </div>

                                    <div class="col-md-6 fv-row">
                                        <label class="required fs-5 fw-semibold mb-2">Estádo</label>
                                ...
                                <div class="row mb-5">
                                    <div class="col-md-6 fv-row">
                                        <label class="required fs-5 fw-semibold mb-2">Parroquia</label>
                                        <select name="parish" class="form-select form-select-solid">
                                            <option value="1">Catia la mar</option>
                                        </select>
                                    </div>

                                    <div class="col-md-6 fv-row">
                                        <label class="required fs-5 fw-semibold mb-2">Sector</label>
