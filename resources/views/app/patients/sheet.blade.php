    ...
    <div class="card p-5 m-5 mb-5 mb-xl-5">
        <div class="card-header border-0">
            <div class="card-title">
                <h2 class="fw-bold text-warning mb-0">Comprobante de cita</h2>
            </div>
        </div>
                    ...
                    <div class="d-flex flex-wrap py-5">
                        <div class="flex-equal me-5">
                            <table class="table table-flush fw-semibold gy-1">
                                <tr>
                                    <td class="text-warning min-w-125px w-125px">Nombre</td>
                                ...
                                <tr>
                                    <td class="text-warning min-w-125px w-125px">Cédula</td>
                                    <td class="text-gray-800">{{ $reservation->patient->document }} </td>
                                </tr>
                                <tr>
                                    <td class="text-warning min-w-125px w-125px">Teléfono</td>
                                    <td class="text-gray-800">{{ $reservation->patient->phone }} </td>
                                </tr>
                                <tr>
                                    <td class="text-warning min-w-125px w-125px">Edad</td>
                                    <td class="text-gray-800">{{ $reservation->patient->age }} </td>
                                </tr>
                                <tr>
                                    <td class="text-warning min-w-125px w-125px">Dirección</td>
                                    <td class="text-gray-800">
                                ...
                                <tr>
                                    <td class="text-warning min-w-125px w-125px">Sector</td>
                                    <td class="text-gray-800">
                        ...
                        <div class="flex-equal">
                            <table class="table table-flush fw-semibold gy-1">
                                <tr>
                                    <td class="text-warning min-w-125px w-125px">Área de atención</td>
                                    <td class="text-gray-800">{{ ucwords($reservation->MedicalArea->name) }} </td>
                                </tr>
                                <tr>
                                    <td class="text-warning min-w-125px w-125px">Especialista</td>
                                    <td class="text-gray-800">
                                ...
                                <tr>
                                    <td class="text-warning min-w-125px w-125px">Fecha</td>
                                ...
                                <tr>
                                    <td class="text-warning min-w-125px w-125px">Observación</td>
                                    <td class="text-gray-800">{{ $reservation->observation }} </td>
                                </tr>
                                <tr>
                                    <td class="text-warning min-w-125px w-125px">Estatus</td>
