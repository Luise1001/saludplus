...
@section('content')
    ...
    <div class="card card-flush mb-3 mt-3">
        <div class="card-header">
            ...
            <div class="card-toolbar">
                ...
                <a href="{{ route('app.index') }}"class="btn btn-sm btn-warning btn-active-light-warning mx-3">
    ...
    <div class="card p-5">
        @include('app.hospital.reservation.components.table')
    </div>

    @include('app.hospital.reservation.modals.filters')
@endsection
