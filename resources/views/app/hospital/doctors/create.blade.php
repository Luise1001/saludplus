    ...
    <div class="card card-flush mb-3 mt-3">
        <div class="card-header">
            ...
            <div class="card-toolbar">
                <a href="{{ route('hospital.doctor.index') }}"class="btn btn-sm btn-warning btn-active-light-warning">
                    Listado
                </a>
            </div>
        </div>
    ...
    <div class="card mb-5 p-5">
        <div class="d-flex flex-column flex-lg-row mb-5">
            <div class="flex-lg-row-fluid me-0 me-lg-20">
                <form action="{{ route('hospital.doctor.create') }}" class="form mb-15" method="post" id="kt_careers_form">
                    @csrf
                    <div class="row mb-5">
