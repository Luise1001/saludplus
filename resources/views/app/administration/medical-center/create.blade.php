    ...
    <div class="card card-flush mb-3 mt-3">
        <div class="card-header">
            <div class="card-title">
                <h2 class="fw-bold">Crear centro médico</h2>
            </div>

            <div class="card-toolbar">
                <a href="{{ route('medical.center.index') }}"class="btn btn-sm btn-primary btn-active-light-primary">
                    Listado
                </a>
            </div>
        </div>
    ...
    <div class="card mb-5 p-5">
        <div class="d-flex flex-column flex-lg-row mb-5">
            <div class="flex-lg-row-fluid me-0 me-lg-20">
                <form action="{{ route('medical.center.create') }}" class="form mb-15" method="post" id="kt_careers_form">
                    @csrf
                    <div class="row mb-5">
                        ...
                        <div class="col-md-6 fv-row">
                            <label for="short_name" class="form-label required fs-5 fw-semibold mb-2">Nombre corto</label>
                    ...
                    <div class="row mb-5">
                        <div class="col-md-6 fv-row">
                            <label for="document" class="form-label required fs-5 fw-semibold mb-2">Rif</label>
                            <input type="text" class="form-control form-control-solid" placeholder="J1234567890"
                                name="document" />
                        </div>

                        <div class="col-md-6 fv-row">
                            <label for="state_id" class="form-label required fs-5 fw-semibold mb-2">Estado</label>
                    ...
                    <div class="row mb-5">
                        <div class="col-md-6 fv-row">
                            <label for="municipality_id" class="form-label required fs-5 fw-semibold mb-2">Municipio</label>
                        ...
                        <div class="col-md-6 fv-row">
                            <label for="parish_id" class="form-label required fs-5 fw-semibold mb-2">Parroquia</label>
