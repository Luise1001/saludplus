        ...
        <div class="d-flex align-items-stretch justify-content-between flex-lg-grow-1" id="kt_app_header_wrapper">
            ...
            <div class="app-navbar flex-shrink-0">
                ...
                @if (auth()->user())
                    ...
                    <div class="app-navbar-item ms-1 ms-md-4" id="kt_header_user_menu_toggle">
                         <a class="btn btn-sm btn-primary btn-active-light-primary fw-bold" href="{{ route('login') }}">Iniciar Sesión</a>
                    </div>

                    <div class="app-navbar-item ms-1 ms-md-4" id="kt_header_user_menu_toggle">
                        <a class="btn btn-sm btn-primary btn-active-light-primary fw-bold" href="{{ route('register') }}">Registrarse</a>
                    </div>
                @endif
